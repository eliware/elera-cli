...
test('dispatches the management, routing, identity, and cluster command families', async () => {
  ...
  const environment = { ELERA_API_ENDPOINT: 'http://supervisor', ELERA_API_TOKEN: 'token', ELERA_DATABASE: 'app', ELERA_IDENTITY: 'runtime' };
  const commands = [['routes', 'app'], ['bundle'], ['routing-resync', 'app'], ['drain'], ['undrain'], ['drain-status'], ['metadata-init', '--confirm'], ['metadata-status'], ['metadata-verify'], ['reconcile-plan', '{}'], ['reconcile-apply', '{}'], ['reconcile-verify', '{}'], ['restore-metadata-plan', '{}'], ['restore-metadata-apply', '{}'], ['restore-accounts-plan', '[]'], ['restore-accounts-apply', '[]'], ['restore-accounts-verify', '[]'], ['database-list'], ['database-create', 'app', 'db'], ['identity-list', 'app'], ['identity-create', 'app', 'db', 'id'], ['identity-rotate', 'id'], ['account-create', 'u', 'db'], ['account-revoke', 'u'], ['account-verify', 'u'], ['token-create', 't', 'app', 'id'], ['token-revoke', 't'], ['cluster-status'], ['cluster-observations'], ['cluster-quorum'], ['cluster-plan', 'drain'], ['cluster-bootstrap', '--confirm'], ['cluster-join', '--confirm'], ['cluster-leave', '--confirm'], ['cluster-recover', '--confirm']];
