...
import { runDatabaseDelete } from "../commands/database/delete.mjs";
import { runApplicationCreate, runApplicationStatus, runAppAdminCreate } from "../commands/app.mjs";
...
import { runMigrationExplain, runMigrationPending } from "../commands/migration.mjs";
import { runNodeResetData } from "../commands/node/reset-data.mjs";
import { runNodeResync } from "../commands/node/reset-data.mjs";
...
export async function runCli({
  ...
  if (mutatingCommands.has(command) && argv.includes("--dry-run") && command !== 'node-reset-data') {
